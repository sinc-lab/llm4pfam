...
class ProtCNN(nn.Module):
    """Pytorch (adapted) implementation of ProtCNN from 
https://github.com/google-research/google-research/blob/master/using_dl_to_annotate_protein_universe/neural_network/protein_model.py"""

    def __init__(self, input_size, filters=1100, kernel_size=9, num_layers=5, 
                 first_dilated_layer=2, dilation_rate=3, 
