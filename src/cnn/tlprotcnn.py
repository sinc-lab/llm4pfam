"""
TLProtCNN class definition. This class uses ProtCNN architecture
but gets protein embedders as input. Adapted from:
https://github.com/sinc-lab/transfer-learning-pfam/blob/master/tlprotcnn.py
"""
...
class TLProtCNN(nn.Module):
    def __init__(self, nclasses, lr=1e-3, nfilters=1100, device="cuda",
    logger=None, emb_size=1280):
        ...
        self.fc = nn.Linear(nfilters, nclasses)
